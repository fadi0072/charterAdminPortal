...
const ModalComponent = (props) => {
    ...
    return (
        <>
            <div className={`modal fade ${props.className}`} id={props.id} tabIndex="-1" aria-labelledby={props.exampleModalLabel} data-bs-backdrop={props.dataBsBackdrop} aria-hidden={!show} style={{display: "none"}}>
